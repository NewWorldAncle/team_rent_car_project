		...
		<div class="car_wrap">
			...
			<form action="registerOk" method="post">
				<table class="carTable">
					...
					<tr>
						...
						<td><input type="text" name="category"
							placeholder="숫자만 입력하세요">1.소형 2.중형 3.대형</td>
					</tr>
					<tr>
						<td>가격</td>
					...
					<tr>
						<td>차량이미지</td>
						<td><input type="text" name="imgName" id="imgName"> <input
							type="file" name="img"
				...
				<div class="menu_wrap">
					...
					<input class="no_button btnSpace" type="button" value="취소"
						onclick="javascript:window.location='/rentcar/car/carList'" />
				</div>
			</form>
		</div>
	</section>
