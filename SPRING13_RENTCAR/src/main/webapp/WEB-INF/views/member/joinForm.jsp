...
<body>
	<form action="join" method="post" name="reg_frm">
		<div class="joinWrap" align="center">
			<table>
				<tr class="id_wrap">
					<th>아이디</th>
					<td>
				...
				<tr class="eamil_wrap">
					<th>이메일</th>
					<td><input type="email" name="email" placeholder="'@'를 포함하여 입력해주세요"></td>
				</tr>
				<tr class="tel_wrap">
					<th>전화번호</th>
					<td><input type="text" name="tel" placeholder="'-'를 포함하여 입력해주세요"></td>
				</tr>
				<tr class="age_wrap">
					<th>연령대</th>
					<td>
				...
				<tr class="menu_wrap" align="center">
					<td colspan="2">
						<input type="button" value="가입" name="confirm" onclick="infoConfirm()">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" value="취소" name="cancel" onclick="javascript:window.location='loginForm'"/>
					</td>
				</tr>
			</table>
		</div>
